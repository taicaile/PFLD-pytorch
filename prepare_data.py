...
class ImageDate:
    def __init__(self, line, imgDir, image_size=112):
        ...
        self.landmark = np.asarray(
            list(map(float, line[:196])), dtype=np.float32
        ).reshape(-1, 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", dest="root", default="data", help="the data root dir")
    ...
    Mirror_file = os.path.join(root_dir, "WFLW/WFLW_annotations/Mirror98.txt")
